...
local function vapeGithubRequest(scripturl, isImportant)
    ...
    local suc, res
    local url = (scripturl == 'Universal.lua' or scripturl == 'VWUniversal'or scripturl ==  'GuiLibrary.lua' or scripturl == 'MainScript.lua' or scripturl == 'CustomModules/CE6872274481.lua') and"https://raw.githubusercontent.com/FTMteam/xV4/" or "https://raw.githubusercontent.com/VapeVoidware/VoidwareBakup/"
